...
const GsapTo = () => {
  ...
  const gsapSnippet = `gsap.to("#blue-box", {          // hedef seçici
  x: 250,                       // kutuyu sağa 250px taşır
  repeat: -1,                   // sonsuz tekrar
  yoyo: true,                   // her tekrar sonunda tersine oynat
  rotation: 360,                // 360° döndür
  duration: 2,                  // animasyon süresi: 2 sn
  ease: "bounce.in"             // girişte zıplama etkisi
});`;

  useGSAP(
    () => {
      // Box üzerinde çalışan tween'i saklıyoruz ki butonlardan kontrol edelim
      tweenRef.current = gsap.to("#blue-box", {
        x: 250, // kutuyu sağa 250px taşır
        repeat: -1, // sonsuz tekrar
        yoyo: true, // ileri-geri oynat
        rotation: 360, // 360° döndür
        duration: 2, // 2 saniye sürsün
        ease: "bounce.in", // girişte zıplama eğrisi
      });
          ...
          <div className="p-6">
            ...
            <div className="relative h-48 rounded-xl bg-gradient-to-br from-zinc-50 via-zinc-100 to-zinc-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 border border-zinc-200 dark:border-zinc-800 flex items-center">
              <div
                id="blue-box"
                ref={boxRef}
                className="w-20 h-20 rounded-xl bg-blue-500 shadow-lg will-change-transform"
                aria-label="Animasyonlu mavi kutu"
              />
            </div>
          </div>
        </div>
          ...
          <div className="p-0">
            ...
            <div className="px-5 pb-5 text-sm text-zinc-600 dark:text-zinc-400">
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  <strong>repeat</strong>: <code>-1</code> sonsuz döngü.
                </li>
                <li>
                  <strong>yoyo</strong>: tur bitince animasyonun tersine dönmesi.
                </li>
                <li>
                  <strong>rotation</strong>: derece cinsinden dönüş.
                </li>
                <li>
                  <strong>duration</strong>: saniye cinsinden süre.
                </li>
                <li>
                  <strong>ease</strong>: hız eğrisi (ör.{" "}
                  <code>bounce.in</code>).
                </li>
              </ul>
            </div>
